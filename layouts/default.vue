    ...
    <v-dialog v-model="currentHelp" width="500">
      <v-card>
        ...
        <v-card-text class="text-justify">
          <p class="mt-8"><strong>«Запитувач»</strong> &mdash; це конструктор запитів, скарг для позовів до суду щодо доступу до публічної інформації у формі відкритих даних (далі &mdash; відкриті публічні дані).</p>
          ...
          <p>Для отримання відкритих публічних даних можна ознайомитись з наборами, які оприлюднені на <a href="https://data.gov.ua" target="_blank">Єдиному державному порталі відкритих даних</a>, на сайті розпорядника або написати <strong>запит</strong> до конкретного розпорядника щодо надання відкритих публічних даних у відповідь. Запит потрібно надіслати на електронну скриньку, вказану для запитів на доступ до публічної інформації на сайті розпорядника або ж на загальну електронну скриньку в розділі «Контакти», якщо спеціальної поштової скриньки для запитів не визначено.</p>
          ...
          <ol class="ml-4 mb-6">
            ...
            <li>Звернутись до адміністративного суду за місцем реєстрації запитувача або розпорядника (УТОЧНИТИ!) за захистом прав і оприлюдненням відкритих публічних даних.</li>
          </ol>
          ...
          <p>Позовна заява, копії додатків мають бути у двох примірниках. Всі копії (всі сторінки) завірені написом «Дата, підпис, ініціали, "Згідно з оригіналом"». </p>
          <p>Успіхів вам в боротьбі за відкриті дані! Пишіть історії успіхів і поразок з хештегом <a href="https://www.facebook.com/hashtag/openuphelper" target="_blank">#openuphelper</a>, щоб ми могли ними теж ділитись.</p>
